...
either direction). Official sources:`https://platform.claude.com/docs/en/about-claude/pricing`,
...
- **Gemini 2.5-family grounding price is a different rate than 3.x — confirmed the
  pricing file correctly has no grounding keys on 2.5-family models (September 2 2026)** — `gemini-2.5-pro`/`gemini-2.5-flash`/`gemini-2.5-flash-lite` grounding is
